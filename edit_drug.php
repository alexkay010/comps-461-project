        ...
        if ($statement = $con->prepare($query)) {
            if ($statement->bind_param("sisisisi", $medicineName, $dosageQty, $dosageUnit, $milligramQty, $milligramUnit, $frequencyQty, $frequencyUnit, $medicine_id)) {
                ...
                if ($statement->execute()) {
                    ...
                    $success_msg = '<h6 class="text-center text-success">Successfully Updated <a href="index.php">View All Medicine</a> </h6>';
                    $row = [];

                } else {

                    $errors[] = 'Error Updating Medicine';
...
<div class="container">
    <div class="row mt-4">
        <div class="col-md-5">
            <h5 class="display-5 mb-4">Edit Medicine</h5>
            <?php
